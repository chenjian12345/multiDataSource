package com.cj.multidatasourcedemo.config;
...
@EnableJpaRepositories(entityManagerFactoryRef = "entityManagerFactoryPrimary", transactionManagerRef = "transactionManagerPrimary", basePackages = {
        "com.cj.multidatasourcedemo.dao.basic" }) //设置Repository所在位置
public class PrimaryConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryPrimary(EntityManagerFactoryBuilder builder)
    {
        return builder.dataSource(primaryDataSource).properties(getVendorProperties())
                .packages("com.cj.multidatasourcedemo.pojo.basic") //设置实体类所在位置
